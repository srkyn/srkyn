...
| [Authorized AI/LMS Security Assessment](https://github.com/srkyn/ai-lms-security-case-study) | Authorized AI assistant assessment with a private 24-page report, 16 validated findings, OWASP LLM-aligned control review, remediation guidance, and a sanitized public case study | [LinkedIn copy](https://github.com/srkyn/ai-lms-security-case-study/blob/main/LINKEDIN.md) |
